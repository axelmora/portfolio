...
subtitle: "2026 Season · Minimum 58 IP overall · Top 10, sorted by BAA vs LHB"
format:
  html:
    echo: false
---
...
overall <- raw %>%
  ...
  transmute(
    ...
    GS, IP_ov = IP_dec, W, L, ERA_ov = ERA, WHIP_ov = WHIP,
...
vs_lhb <- raw %>%
  ...
  transmute(
    pitcher_id, IP_lhb = IP_dec, BAA_lhb = BAA,
...
tbl %>%
  ...
  tab_header(
    title = "Best LMB Starting Pitchers vs. Left-Handed Batters",
    subtitle = "2026 Season · Minimum 52 IP overall · Top 10, sorted by BAA vs LHB"
  ) %>%
